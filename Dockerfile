...
RUN apt-get update && apt-get install -y  gdal-bin libcurl4-openssl-dev libgdal-dev libgeos-dev libgeos++-dev libglpk-dev libgmp-dev libicu-dev libproj-dev libssl-dev libudunits2-dev libxml2-dev make pandoc zlib1g-dev && rm -rf /var/lib/apt/lists/*
...
RUN Rscript -e 'remotes::install_version("xfun",upgrade="never")'
...
RUN Rscript -e 'remotes::install_version("ggrepel",upgrade="never")'
...
RUN Rscript -e 'remotes::install_version("markdown",upgrade="never")'
...
RUN Rscript -e 'remotes::install_github("kevinblighe/CorLevelPlot@6bca8ab2e8acd4788dd6a294f57f63841821206b")'
